OC.L10N.register(
    "nmc_email_templates",
    {
		...
		"With the status mail for %s, we inform you once a month about your used storage space and your granted shares." : "Mit der Status-Mail zur %s informieren wir Sie einmal monatlich über Ihren belegten Speicherplatz und über Ihre erteilten Freigaben.",
		"We also give you tips and tricks for using your %s every day. You can find out how to upload, move, share files and more here: <a href=\"%s\">Help</a>" : "Außerdem geben wir Ihnen Tipps und Tricks zum täglichen Umgang mit Ihrer %s. Wie Sie Dateien hochladen, verschieben, freigeben usw., erfahren Sie hier: <a href=\"%s\">Hilfe</a>",
		"We also give you tips and tricks for using your %s every day. You can find out how to upload, move, share files and more here: Help" : "Außerdem geben wir Ihnen Tipps und Tricks zum täglichen Umgang mit Ihrer %s. Wie Sie Dateien hochladen, verschieben, freigeben usw., erfahren Sie hier: Hilfe",
		...
		"of your memory is currently occupied.":"Ihres Speichers sind derzeit belegt.",
		"of your memory is currently occupied. You can expand your storage space at any time up to 5 TB as required.":"Ihres Speichers sind derzeit belegt. Sie können Ihren Speicherplatz jederzeit nach Bedarf auf bis zu 5 TB erweitern.",
		"We also give you tips and tricks on how to use your MagentaCLOUD on a daily basis.":"Außerdem geben wir Ihnen Tipps und Tricks zum täglichen Umgang mit ihrer MagentaCLOUD.",
		"You can find out how to upload, move, share, etc. files here:":"Wie Sie Dateien hochladen, verschieben, freigeben, etc., erfahren Sie hier:",
		"First steps":"Erste Schritte",
		"With the MagentaCLOUD status e-mail, we will inform you once a month about the storage space you have used and the permissions you have been granted.":"Mit der Status-Mail zur MagentaCLOUD informieren wir sie einmal monatlich über ihren belegten Speicherplatz und über Ihre erteilten Freigaben.",
		"First Steps":"Erste Schritte",
		"You have shared":"Sie haben",
		"items. You can manage your shares with one click.":"Inhalte geteilt. Mit einem Klick können Sie Ihre Freigaben verwalten.",
		"My share":"Meine geteilten Inhalte",
		"Quota warning":"Kontingentwarnung",
		"Shares" : "Freigaben",
		"Storage" : "Speicherplatz",
		"My Share" : "Mein Anteil",
		"Storage space: %s %s used." : "Speicherplatz: %s %s verwendet.",
		...
		"Practical: With the app, you can automatically synchronize up your photos and videos to your MagentaCLOUD if you wish.":"Praktisch: Mit der App sichern Sie auf Wunsch Ihre Fotos und Videos automatisch in Ihrer MagentaCLOUD.",
