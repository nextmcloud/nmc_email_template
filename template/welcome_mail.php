...
">
			<img src="'.$this->urlPath.'themes/nextmagentacloud21/core/img/logo.png" width="72px" height="35px"/>
			...
			<td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 32px 0;">
				...
				<tr>
					...
					<div style="">
						...
						<li style="margin-bottom: 8px;background: url('.$this->urlPath.'themes/nextmagentacloud21/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Keep memories safe').'</li>
						<li style="margin-bottom: 8px;background: url('.$this->urlPath.'themes/nextmagentacloud21/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Share special moments with family').'</li>
						<li style="margin-bottom: 8px;background: url('.$this->urlPath.'themes/nextmagentacloud21/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Keep all files in overview').'</li>
						<li style="margin-bottom: 0px;background: url('.$this->urlPath.'themes/nextmagentacloud21/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Expand device memory free of charge').'</li>
						</ul>
