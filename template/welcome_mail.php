...
<table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background-color: #fff;">
	...
	<td class="container" style="font-family: sans-serif; font-size: 14px; display: block; Margin: 0 auto; max-width: 600px; width: 600px;">
		...
		<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
			...
			<img src="'.$this->urlPath.'themes/magentacloud25/core/img/email/logo-new-updated.png" height="35px"/>
			</td>
			...
			<img src="'.$this->urlPath.'themes/magentacloud25/core/img/email/welcome-banner.png" width="100%" style="margin-top: 16px;"/>
			</td>
			</tr>
		</table>
		</div>
			...
			<td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 32px 0;">
				...
				<tr style="background-color: #f1f1f1;">
					...
					<div style="Width: 100%;padding-top: 32px;padding-bottom: 24px;padding-left: 24px;box-sizing: border-box;">
						<img src="'.$this->urlPath.'themes/magentacloud25/core/img/email/mobile.png" width="48px" height="48px">
					...
					<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;padding-right: 12px;">
						...
						<img src="'.$this->urlPath.'themes/magentacloud25/core/img/email/computer.png" width="48px" height="48px" style="margin-right: 8px;">
				...
				<tr>
					...
					<div style="">
						...
						<li style="margin-bottom: 8px;background: url('.$this->urlPath.'themes/magentacloud25/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Keep memories safe').'</li>
						<li style="margin-bottom: 8px;background: url('.$this->urlPath.'themes/magentacloud25/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Share special moments with family').'</li>
						<li style="margin-bottom: 8px;background: url('.$this->urlPath.'themes/magentacloud25/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Keep all files in overview').'</li>
						<li style="margin-bottom: 0px;background: url('.$this->urlPath.'themes/magentacloud25/core/img/email/checkmark.png); background-repeat: no-repeat;text-indent: 32px;">'.$this->l10n->t('Expand device memory free of charge').'</li>
						</ul>
