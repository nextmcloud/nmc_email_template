                      ...
                      <td style="font-family: sans-serif; font-size: 12px; vertical-align: top;padding-left: 32px;padding-right: 16px">
                        ...
                        <td style="font-family: sans-serif; font-size: 12px; vertical-align: top;padding-right: 24px;padding-left: 16px">
                          ...
                          <span style="font-weight: bold;">Quota Warning</span>
                            ...
                            <a href="#" target="_blank" style="display: inline-block;color: #191919;background-color: #f1f1f1;border: 1px solid #191919;border-radius: 8px;box-sizing: border-box;cursor: pointer;text-decoration: none;font-size: 12px;font-weight: bold;margin: 0;padding: 12px 24px;text-transform: capitalize;margin-right: 8px;">Expand Storage</a>
                            <a href="#" target="_blank" style="display: inline-block;color: #191919;background-color: #f1f1f1;border: 1px solid #191919;border-radius: 8px;box-sizing: border-box;cursor: pointer;text-decoration: none;font-size: 12px;font-weight: bold;margin: 0;padding: 12px 24px;text-transform: capitalize;">Open the trash</a>
                          </div>
                          </td>              
                      </tr>
                   </table>
