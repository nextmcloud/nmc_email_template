                      ...
                      <td style="font-family: sans-serif; font-size: 12px; vertical-align: top;padding-left: 32px;padding-right: 16px">
                        ...
                        <td style="font-family: sans-serif; font-size: 12px; vertical-align: top;padding-right: 24px;padding-left: 16px">
                          ...
                          <span style="font-weight: bold;">Quota Warning</span>
                            <p style="font-size: 12px;margin-top: 8px;margin-bottom: 16px;"><span style="font-size: 12px;font-weight: bold;">85%</span> of your storage is currently occupied.Once your memory is used up,you cannot upload any more files.However,you can remove files or empty you recycle bin at any time</p>
